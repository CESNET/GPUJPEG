# Modified version of https://github.com/Kitware/CMake/blob/master/Modules/FindGLUT.cmake
#
#.rst:
# FindGLUT
# --------
...
if (WIN32)
  ...
  find_file(GLUT_DLL NAMES GLEW freeglut.dll glut.dll glut32.dll PATH_SUFFIXES ${path_suffix})
  if(GLUT_DLL STREQUAL "GLUT_DLL-NOTFOUND")
    unset(GLUT_DLL CACHE)
  endif()
else ()
