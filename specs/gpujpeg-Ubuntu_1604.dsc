...
DEBTRANSFORM-TAR:	libgpujpeg-20170209.tar.bz2
DEBTRANSFORM-FILES-TAR:	debian.tar.gz
DEBTRANSFORM-SERIES:	debian-patches-Ubuntu_1604.series
Format: 1.0
Source: libgpujpeg
Binary: libgpujpeg
Architecture: any
...
Build-Depends: 	debhelper (>= 7.0.50~), build-essential, make, autoconf, automake, libtool, nvidia-cuda-toolkit (>= 6.0)
